...
'''
File Name: yolo_detect.py

Description: This script provides a class for deploying a yolo model to detect objects with oriented bounding boces

Usage: For use with yolov5obb. Create an instance of the YoloV5Detector class
...
class YOLOV5Detector():
    ...
    def parse_opt(self):
        ...
        parser.add_argument('--source', type=str, default='captured_video2.mp4', help='file/dir/URL/glob, 0 for webcam')
