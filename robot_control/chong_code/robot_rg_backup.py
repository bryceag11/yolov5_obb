...
class RobotMovement():
    ...
    file = open(r'D:\Code\yolov5_obb\robot_control\chong_code\Rgripper.script', 'rb')
    header = file.read()
    output = header
...
def grip_first_one():##Edit script for grip Xout1
    RobotMovement.movel(Xout1,Yout1,0.2,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(105, 5, 2)
    # time.sleep(5) # wait for gripper to fully open

    RobotMovement.movel(Xout1,Yout1,0.0009,L1[3],L1[4],L1[5],acc,speed)
    RobotMovement.rg_grip(75, 20, 2)
    # time.sleep(5) # wait for gripper to fully close

    RobotMovement.movel(Xout1,Yout1,0.2,L1[3],L1[4],L1[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.2,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.0009,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(90, 5, 2)
    # time.sleep(5) # wait for gripper to fully open
    RobotMovement.movel(L0[0],L0[1],0.2,L0[3],L0[4],L0[5],acc,speed)
...
def grip_second_one(): 
    RobotMovement.movel(Xout1,0.10,0.21,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(88, 5, 2)
    RobotMovement.movel(Xout1,0.10,0.035,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(19, 15, 2)
    # time.sleep(5) # wait for gripper to fully close

    RobotMovement.movel(Xout1,Yout2,0.2,L1[3],L1[4],L1[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.2,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.0723,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(100, 5, 2)
    # time.sleep(5) # wait for gripper to fully open
    RobotMovement.movel(L0[0],L0[1],0.2,L0[3],L0[4],L0[5],acc,speed)
...
def grip_first_one1():##Edit script for grip Xout1
    RobotMovement.movel(-0.75,0.25,0.2,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(105, 5, 2)
    # time.sleep(5) # wait for gripper to fully open

    RobotMovement.movel(-0.75,0.25,0.0009,L1[3],L1[4],L1[5],acc,speed)
    RobotMovement.rg_grip(75, 20, 2)
    # time.sleep(5) # wait for gripper to fully close

    RobotMovement.movel(-0.75,0.25,0.2,L1[3],L1[4],L1[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.2,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.0009,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(90, 5, 2)
    # time.sleep(5) # wait for gripper to fully open
...
def grip_second_one1(): 
    RobotMovement.movel(-0.75,0,0.21,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(88, 5, 2)
    RobotMovement.movel(-0.75,0,0.035,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(19, 15, 2)
    # time.sleep(5) # wait for gripper to fully close

    RobotMovement.movel(-0.75,0,0.2,L1[3],L1[4],L1[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.2,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.movel(L0[0],L0[1],0.0723,L0[3],L0[4],L0[5],acc,speed)
    RobotMovement.rg_grip(100, 5, 2)
    # time.sleep(5) # wait for gripper to fully open
...
# RobotMovement.movel(L0[0],L0[1],0.2,L0[3],L0[4],L0[5],acc,speed)  # back to spawn
# RobotMovement.movel(Xout1,Yout1,0.0009,L1[3],L1[4],L1[5],acc,speed)# To box one

# RobotMovement.movel(Xout1,0.10,-0.00138,L0[3],L0[4],L0[5],acc,speed)#To box two
# RobotMovement.rg_grip(19, 15, 2)
# RobotMovement.movel(Xout1,0.10,0.1,L0[3],L0[4],L0[5],acc,speed)#To box two above
# RobotMovement.movel(Xout1,0.10,-0.00138,L0[3],L0[4],L0[5],acc,speed) #To box two
# RobotMovement.rg_grip(105, 15, 2)



#####for vg test
# RobotMovement.movel(Xout1,Yout1,0.21,L0[3],L0[4],L0[5],acc,speed)
# RobotMovement.movel(Xout1,Yout1,-0.125,L1[3],L1[4],L1[5],acc,speed)
# RobotMovement.vg_grip(2,30,0.0,"False",0.0,0.0)

# RobotMovement.movel(Xout1,Yout1,0.21,L1[3],L1[4],L1[5],acc,speed)
# RobotMovement.movel(L0[0],L0[1],0.21,L0[3],L0[4],L0[5],acc,speed)
# RobotMovement.movel(L0[0],L0[1],-0.117,L0[3],L0[4],L0[5],acc,speed)
# RobotMovement.vg_release(2, 5.0, "False")
# # time.sleep(5) # wait for gripper to fully open
# RobotMovement.movel(L0[0],L0[1],0.21,L0[3],L0[4],L0[5],acc,speed)
...
#second
# RobotMovement.movel(L0[0],L0[1],L0[2],L0[3],L0[4],L0[5],acc,speed)
# RobotMovement.rg_grip(100, 5, 2)
# time.sleep(5) # wait for gripper to fully open
# RobotMovement.movel(L1[0],L1[1],L1[2],L1[3],L1[4],L1[5],acc,speed)
# RobotMovement.rg_grip(80, 5, 2)
# time.sleep(5) # wait for gripper to fully close
# RobotMovement.movel(L0[0],L0[1],L0[2],L0[3],L0[4],L0[5],acc,speed)
# # #RobotMovement.rg_grip(100, 5, 2)
# RobotMovement.execute(robot)
...
# RobotMovement.rg_grip(100, 5, 2, robot)
# time.sleep(5)
