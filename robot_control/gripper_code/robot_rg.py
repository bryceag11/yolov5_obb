...
class RobotMovement():
    def __init__(self):
        ...
        self.file = open(r'C:\Users\bag100\IR10_UGF25_PROJECT\yolov5_obb\robot_control\chong_code\Rgripper.script', 'rb')
    ...
    def rg_grip(self, robot, width, force, mass):      # control the gripper
        ...
        on_return = b"on_return=rg_grip(" + width + b", " + force + b", tool_index = 0, blocking = True, depth_comp = True, popupmsg = True)"
